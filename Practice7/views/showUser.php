...
<div class="container">
    ...
    <form action="?controller=users&action=edit" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="field">
                <label>Enter name: <input type="text" name="name" value="<?=$user['name']?>"></label>
            </div>
        </div>
        <div class="row">
            <div class="field">
                <label>Enter e-mail: <input type="email" name="email" value="<?=$user['email']?>"><br></label>
            </div>
        </div>
        <div class="row">
            <div class="field">
                <label>Enter password: <input type="password" name="password" value="<?=$user['password']?>"><br></label>
            </div>
        </div>
        <div class="row">
            <div class="field">
