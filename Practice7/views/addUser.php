                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center pt-4 pb-3">
                                <div class="col-md-3 ps-5">
                                    <h6 class="mb-0">Enter your surname:</h6>
                                </div>
                            ...
                            <div class="row align-items-center py-3">
                                <div class="col-md-3 ps-5">
                                    <h6 class="mb-0">Enter e-mail address:</h6>
                                </div>
                                <div class="col-md-9 pe-5">
                                    <label>
                            ...
                            <div class="row align-items-center py-3">
                                ...
                                <div class="col-md-9 pe-5">
                                    <select class="form-select" name="roles">
                                        <option selected>Selection menu (nessesary)</option>
                                        <?php
                                            foreach ($roles as $role):
                                                echo "<option id='role' name='roles' value='".$role['id']."'>". $role['title'] . "</option>";
                                            endforeach;
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="row align-items-center py-3">
                                ...
                                <div class="col-md-9 pe-5">
                                    ...
                                    <div class="small text-muted mt-2">Upload photo (Max size = 4MB)</div>
                                </div>
                            </div>
